...
class TimePolicy
{
    ...
    {
        return $user->can('force_delete_time');
    }
    ...
    {
        return $user->can('force_delete_any_time');
    }
    ...
    {
        return $user->can('restore_any_time');
    }
     ...
     * @return bool
     */
    public function replicate(User $user, Time $time): bool
    {
        return $user->can('replicate_time');
    }
